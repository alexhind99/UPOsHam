...
import differential_correction_voter97b as diff_corr_unc
...
def hausd_dist_numeric_analytic(orbit, t, deltaE_val, parameters):
    ...
    y, py = voter97.upo_analytical(total_energy, t, parameters)
...
class TestUnstablePeriodicOrbit(unittest.TestCase):
    ...
    def test_differential_correction(self):
        ...
        for deltaE_val in deltaE_vals:
            with open(path_to_data + "x0_diffcorr_deltaE%s_voter97uncoup_b.dat" %(deltaE_val), 'a+') as po_fam_file: 
